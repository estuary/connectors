...
| `/advanced/compress_staged_files` | Compress Staged Files | When enabled, files staged to the Unity Catalog volume are compressed with gzip. This reduces the amount of data uploaded to Databricks, at the cost of additional CPU usage. | boolean | `false` |
