...
class SourceGithub(AbstractSource):
    ...
    def _get_org_repositories(
        ...
        if unchecked_repos:
            stream = RepositoryStats(
                ...
                page_size_for_large_streams=config.get(
    ...
    def get_access_token(config: Mapping[str, Any]):
        ...
        if "personal_access_token" in credentials:
            return constants.PERSONAL_ACCESS_TOKEN_TITLE, credentials[
    ...
    def user_friendly_error_message(self, message: str) -> str:
        user_message = ""
        if (
            "404 Client Error: Not Found for url: https://api.github.com/repos/"
            in message
        ):
            # 404 Client Error: Not Found for url: https://api.github.com/repos/airbytehq/airbyte3?per_page=100
            full_repo_name = message.split("https://api.github.com/repos/")[1].split(
                "?"
            )[0]
            ...
            "404 Client Error: Not Found for url: https://api.github.com/orgs/"
            in message
        ):
            ...
            user_message = "Github credentials have expired or changed, please review your credentials and re-authenticate or renew your access token."
        return user_message
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        project_columns_stream = ProjectColumns(
            projects_stream, **repository_args_with_start_date
        )
        ...
        return [
            ...
            WorkflowJobs(
                parent=workflow_runs_stream, **repository_args_with_start_date
            ),
