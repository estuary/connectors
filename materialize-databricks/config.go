...
type advancedConfig struct {
	...
	CompressStagedFiles bool   `json:"compress_staged_files,omitempty" jsonschema:"title=Compress Staged Files,description=Compress files staged to the Unity Catalog volume with gzip. This reduces the volume of data uploaded at the cost of additional CPU usage.,default=false" jsonschema_extras:"nonsensitive=true"`
