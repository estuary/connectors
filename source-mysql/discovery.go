...
const queryDiscoverColumns = `
  SELECT col.table_schema, col.table_name, col.ordinal_position, col.column_name, col.is_nullable, col.data_type, col.column_type, tbl.table_type
  FROM information_schema.columns col
  JOIN information_schema.tables tbl
    ON (col.table_schema = tbl.table_schema AND col.table_name = tbl.table_name)
