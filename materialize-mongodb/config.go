...
type config struct {
	Address    string `json:"address" jsonschema:"title=Address" jsonschema_description:"The connection URI for your deployment without the username and password. For example mongodb+srv://my-mongo.test?authSource=admin." jsonschema_extras:"order=0"`
...
type resource struct {
	...
	DeltaUpdates bool   `json:"delta_updates,omitempty" jsonschema:"title=Delta updates,default=false" jsonschema_extras:"x-delta-updates=true,nonsensitive=true"`
