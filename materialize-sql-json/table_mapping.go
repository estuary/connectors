...
// ConvertKey converts a key value to database parameters.
func (t *Table) ConvertKey(key []interface{}) (out []interface{}, err error) {
	return convertValue(key, t.Keys, out)
}

// ConvertAll converts the composite key values, value values, and the document RawMessage into
// database parameters.
func (t *Table) ConvertAll(key, values []interface{}, doc json.RawMessage) (out []interface{}, err error) {
	...
	if out, err = convertValue(key, t.Keys, out); err != nil {
		return nil, err
	} else if out, err = convertValue(values, t.Values, out); err != nil {
		return nil, err
	}
...
func convertValue(in []interface{}, columns []Column, out []interface{}) ([]interface{}, error) {
