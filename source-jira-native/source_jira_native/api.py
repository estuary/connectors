...
# Jira has documentation stating that it's API doesn't provide read-after-write consistency by default.
...
# issues are consistent. However, that has it's own drawbacks - we'd likely need to make one request to fetch
