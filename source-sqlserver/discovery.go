...
type discoveryFilters struct {
	IncludeSchemas      []string `json:"include_schemas,omitempty" jsonschema:"title=Include Schemas,description=If specified only tables in the listed schemas will be discovered." jsonschema_extras:"nonsensitive=true"`
	...
	DiscoverOnlyEnabled bool     `json:"discover_only_enabled,omitempty" jsonschema:"title=Discover Only CDC-Enabled Tables,description=When set the connector will only discover tables which have already had CDC capture instances enabled. Combined as a union with the equivalent setting under Advanced Options." jsonschema_extras:"nonsensitive=true"`
}
