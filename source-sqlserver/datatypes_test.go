...
func TestDatatypes(t *testing.T) {
	...
	tests.TestDatatypes(ctx, t, tb, []tests.DatatypeTestCase{
		...
		{ColumnType: `char(6)`, ExpectType: `{"type":["string","null"],"maxLength":6}`, InputValue: `asdf`, ExpectValue: `"asdf  "`},
		...
		{ColumnType: `nchar(6)`, ExpectType: `{"type":["string","null"],"maxLength":6}`, InputValue: `asdf`, ExpectValue: `"asdf  "`},
		...
		{ColumnType: `binary(8)`, ExpectType: `{"type":["string","null"],"contentEncoding":"base64","maxLength":12}`, InputValue: []byte{0x12, 0x34, 0x56, 0x78}, ExpectValue: `"EjRWeAAAAAA="`},
