...
const (
	SERVICE_AUTH_TYPE = "Service" // For service account credentials
	CLIENT_AUTH_TYPE  = "Client"  // For clients (web browsers) to use oauth
)
...
func (CredentialConfig) JSONSchema() *jsonschema.Schema {
	...
	serviceAccountProps.Set("credentials_json", &jsonschema.Schema{
