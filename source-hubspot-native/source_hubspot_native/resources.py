...
from .api import (
    ...
    fetch_delayed_contact_list_memberships,
    ...
    fetch_recent_contact_list_memberships,
...
def contact_lists(http: HTTPSession) -> Resource:
    def open(
        ...
        open_binding(
            ...
            fetch_page=functools.partial(backfill_contact_lists, http),
        )
    ...
    return Resource(
        ...
        initial_state=ResourceState(
            ...
            backfill=ResourceState.Backfill(
                next_page=EPOCH_PLUS_ONE_SECOND.isoformat(), cutoff=started_at
            ),
        ),
        initial_config=ResourceConfig(
    ...
    def open(
        ...
        open_binding(
            ...
            fetch_changes=functools.partial(
                ...
                fetch_delayed_contact_list_memberships,
                http,
                False,  # contact list memberships do not have property history
            ),
