...
// path for doing that.
func (kc *kinesisCapture) listInitialShards() ([]*kinesis.Shard, error) {
...
func (kc *kinesisCapture) overlapsHashRange(shard *kinesis.Shard) (shardrange.OverlapResult, error) {
...
func (kc *kinesisCapture) startReadingShardByID(shardID string) {
...
func (kc *kinesisCapture) newShardReader(shardID string, getShard func(string) (*kinesis.Shard, error)) (*kinesisShardReader, error) {
...
func (r *kinesisShardReader) readShard() {
...
func (r *kinesisShardReader) extractRecords(resp *kinesis.GetRecordsOutput) []json.RawMessage {
...
func (r *kinesisShardReader) getShardIterator() (string, error) {
