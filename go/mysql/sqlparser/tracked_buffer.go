...
// BindLocation tracks the offset and length of a bind-variable argument
// written into the buffer. Upstream this lived in parsed_query.go alongside
// the (dropped) bind-variable substitution machinery; the parser still records
// these locations as it formats Argument nodes.
