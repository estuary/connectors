...
| column_attribute_list_opt VISIBLE
  {
    $1.Invisible = ptrOf(false)
    $$ = $1
  }
| column_attribute_list_opt INVISIBLE
  {
    $1.Invisible = ptrOf(true)
    $$ = $1
  }
...
| '(' INTEGRAL ',' INTEGRAL ')'
  {
    $$ = LengthScaleOption{
        Length: ptrOf(convertStringToInt($2)),
        Scale: ptrOf(convertStringToInt($4)),
    }
  }
...
| ALTER column_opt column_name SET VISIBLE
  {
    $$ = &AlterColumn{Column: $3, Invisible: ptrOf(false)}
  }
| ALTER column_opt column_name SET INVISIBLE
  {
    $$ = &AlterColumn{Column: $3, Invisible: ptrOf(true)}
  }
...
| AS BINARY '(' INTEGRAL ')'
  {
    $$ = &ConvertType{Type: string($2), Length: ptrOf(convertStringToInt($4))}
  }
| AS CHAR '(' INTEGRAL ')'
  {
    $$ = &ConvertType{Type: string($2), Length: ptrOf(convertStringToInt($4))}
