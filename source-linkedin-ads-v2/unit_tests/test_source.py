...
from source_linkedin_ads_v2.source import (
    Accounts,
    AccountUsers,
    AdCampaignAnalytics,
    AdCreativeAnalytics,
...
from source_linkedin_ads_v2.streams import LINKEDIN_VERSION_API
...
class TestAllStreams:
    ...
    @patch("source_linkedin_ads_v2.source.Accounts.check_availability")
