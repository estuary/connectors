...
# Zuora returns 403 when the generated export file exceeds its size limit
# (2047 MB). https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/G_SOAP_API/E1_SOAP_API_Object_Reference/Export
...
class ExportManager:
    ...
    async def _fetch_results(self, file_id: str) -> AsyncGenerator[dict, None]:
        ...
        try:
            ...
            if err.code == _FILE_TOO_LARGE_STATUS:
