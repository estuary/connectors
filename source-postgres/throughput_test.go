...
const selectedTableShape = "small_rows"
...
var benchmarkTableShapes = map[string]struct {
	...
	// A table with relatively small rows made of integers and text, but with UUIDv4 keys.
	"small_uuid": {
		Definition: `(
			id UUID PRIMARY KEY,
			x INTEGER,
	...
	// A table with relatively small rows made of integers and text, but with text primary key.
	"small_text": {
		Definition: `(
			id TEXT PRIMARY KEY,
			x INTEGER,
...
func runBenchmarkCapture(ctx context.Context, t testing.TB, cs *st.CaptureSpec) int64 {
	...
	err = protoio.NewUint32DelimitedWriter(&input, binary.LittleEndian).WriteMsg(open.(proto.Message))
	require.NoError(t, err)
...
func BenchmarkBackfill_SmallRows_100M(b *testing.B) { benchBackfillN(b, "small_rows", 100*M) }

func BenchmarkBackfill_SmallText_1M(b *testing.B)   { benchBackfillN(b, "small_text", 1*M) }
func BenchmarkBackfill_SmallText_5M(b *testing.B)   { benchBackfillN(b, "small_text", 5*M) }
func BenchmarkBackfill_SmallText_10M(b *testing.B)  { benchBackfillN(b, "small_text", 10*M) }
func BenchmarkBackfill_SmallText_100M(b *testing.B) { benchBackfillN(b, "small_text", 100*M) }

func BenchmarkBackfill_SmallUUID_1M(b *testing.B)   { benchBackfillN(b, "small_uuid", 1*M) }
func BenchmarkBackfill_SmallUUID_5M(b *testing.B)   { benchBackfillN(b, "small_uuid", 5*M) }
func BenchmarkBackfill_SmallUUID_10M(b *testing.B)  { benchBackfillN(b, "small_uuid", 10*M) }
func BenchmarkBackfill_SmallUUID_100M(b *testing.B) { benchBackfillN(b, "small_uuid", 100*M) }
...
func BenchmarkBackfill_LargeText_100M(b *testing.B) { benchBackfillN(b, "large_text", 100*M) }
...
func BenchmarkBackfill_ManyTypes_100M(b *testing.B) { benchBackfillN(b, "many_types", 100*M) }
...
func BenchmarkReplication_SmallRows_100M(b *testing.B) { benchReplicationN(b, "small_rows", 100*M) }

func BenchmarkReplication_SmallText_1M(b *testing.B)   { benchReplicationN(b, "small_text", 1*M) }
func BenchmarkReplication_SmallText_5M(b *testing.B)   { benchReplicationN(b, "small_text", 5*M) }
func BenchmarkReplication_SmallText_10M(b *testing.B)  { benchReplicationN(b, "small_text", 10*M) }
func BenchmarkReplication_SmallText_100M(b *testing.B) { benchReplicationN(b, "small_text", 100*M) }

func BenchmarkReplication_SmallUUID_1M(b *testing.B)   { benchReplicationN(b, "small_uuid", 1*M) }
func BenchmarkReplication_SmallUUID_5M(b *testing.B)   { benchReplicationN(b, "small_uuid", 5*M) }
func BenchmarkReplication_SmallUUID_10M(b *testing.B)  { benchReplicationN(b, "small_uuid", 10*M) }
func BenchmarkReplication_SmallUUID_100M(b *testing.B) { benchReplicationN(b, "small_uuid", 100*M) }
...
func BenchmarkReplication_LargeText_100M(b *testing.B) { benchReplicationN(b, "large_text", 100*M) }
...
func BenchmarkReplication_ManyTypes_100M(b *testing.B) { benchReplicationN(b, "many_types", 100*M) }
