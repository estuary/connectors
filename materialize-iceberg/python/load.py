import json
from common import NestedField, common_args, fields_to_struct, get_spark_session, run_with_status
...
def run():
    ...
    spark.sql(query).write.csv(output_location, mode="error", header=False, quote="|", compression="gzip", escapeQuotes=False)
