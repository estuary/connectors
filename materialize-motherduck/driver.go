...
type tableConfig struct {
	...
	Delta  bool   `json:"delta_updates,omitempty" jsonschema:"title=Delta Update,description=Should updates to this table be done via delta updates."`
...
func newDuckDriver() *sql.Driver {
	return &sql.Driver{
		...
		NewEndpoint: func(ctx context.Context, raw json.RawMessage, tenant string) (*sql.Endpoint, error) {
			...
			metaSpecs, metaCheckpoints := sql.MetaTables(duckDialect, []string{cfg.Database, cfg.Schema})
