...
func TestIntegration(t *testing.T) {
	...
	t.Run("materialize", func(t *testing.T) {
		sql.RunMaterializationTest(t, newDuckDriver(), "testdata/materialize.flow.yaml", makeResourceFn, nil)
	})
	...
	t.Run("migrate", func(t *testing.T) {
		sql.RunMigrationTest(t, newDuckDriver(), "testdata/migrate.flow.yaml", makeResourceFn, nil)
	})
