...
func quoteIdentifier(name string) string {
	// SQL Server uses square brackets to delimit identifiers that contain special characters
	// or are reserved keywords. To include a closing bracket in an identifier, write "]]".
