	...
	mapper := sql.NewDDLMapper(
		map[sql.FlatType]sql.ProjectionMapper{
			...
			sql.STRING: sql.MapString(sql.StringMappings{
				Fallback: sql.MapStatic("TEXT", boilerplate.StringCastConverter(func(in string) (any, error) {
				...
				WithFormat: map[string]sql.ProjectionMapper{
					"date":      sql.MapStatic("DATE", boilerplate.ClampDate),
					"date-time": sql.MapStatic("TIMESTAMPTZ", boilerplate.ClampDatetime),
