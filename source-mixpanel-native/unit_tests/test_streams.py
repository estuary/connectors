...
from source_mixpanel_native.streams import (
    Annotations,
    CohortMembers,
    Cohorts,
    Engage,
...
from source_mixpanel_native.utils import read_full_refresh
...
def test_should_retry_payment_required(http_status_code, should_retry, log_message, config, caplog):
    ...
    streams = [Annotations, CohortMembers, Cohorts, Engage, Export, ExportSchema, Funnels, FunnelsList, Revenue]
...
def test_raise_config_error_on_creds_expiration(config, caplog, requests_mock):
    streams = []
    for cls in [Annotations, CohortMembers, Cohorts, Engage, Export, ExportSchema, Funnels, FunnelsList, Revenue]:
