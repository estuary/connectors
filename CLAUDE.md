...
- When runnin tests, write the full output to a file, and then read the output from the file. Do not `tail` or `head` the test output as it is very large and you are likely not to find the important lines.
