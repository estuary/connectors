...
@pytest.mark.parametrize(
    ...
    [
        (
            "2023-05-08T03:04:45.139-0700",
            {"type": "string", "format": "date-time"},
            "2023-05-08T03:04:45.139000-07:00",
        ),
        (
            "2022-10-31T09:00:00.594Z",
            {"type": "string", "format": "date-time"},
            "2022-10-31T09:00:00.594000+00:00",
        ),
        (
            "2023-09-11t17:51:41.666-0700",
            {"type": "string", "format": "date-time"},
            "2023-09-11T17:51:41.666000-07:00",
        ),
...
def test_converting_date_with_incorrect_format_returning_original_value(config, caplog):
    ...
    assert (
        f"{incorrectly_formatted_date}: doesn't match expected format." in caplog.text
    )
