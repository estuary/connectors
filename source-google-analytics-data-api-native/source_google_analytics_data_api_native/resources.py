        ...
        try:
            ...
            for dimension in model.dimensions:
                if dimension not in valid_dimensions:
                    errors.append(f'"{dimension}" in report "{model.name}" is not a valid dimension. Consult Google\'s documentation for a list of valid dimensions.')

            for metric in model.metrics:
                if metric not in valid_metrics:
                    errors.append(f'"{metric}" in report "{model.name}" is not a valid metric. Consult Google\'s documentation for a list of valid dimensions.')
