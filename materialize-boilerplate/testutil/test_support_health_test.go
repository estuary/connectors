...
func TestAssertTransactionHealth(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{name: "no lines at all, declared total", lines: nil, shards: 1, declared: m.FidelityTotal, wantFail: "covered stored documents"},
		{name: "no lines at all, declared none", lines: nil, shards: 1, declared: m.FidelityNone},
		{name: "no lines at all, undeclared", lines: nil, shards: 1},
