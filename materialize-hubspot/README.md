...
The HubSpot connector materiaizes CRM Object into the HubSpot CRM.  This
...
connector always operates in delta-update mode.  More on this later.
...
In the `materialization-hubspot/cmd/hubspot-cli` is a tool for performing some
