...
exportToJsonl "\`$DATABRICKS_CATALOG\`.\`some-schema\`.all_key_types_part_one"
exportToJsonl "\`$DATABRICKS_CATALOG\`.\`some-schema\`.all_key_types_part_two"
exportToJsonl "\`$DATABRICKS_CATALOG\`.\`some-schema\`.all_key_types_part_three"
exportToJsonl "\`$DATABRICKS_CATALOG\`.\`some-schema\`.fields_with_projections"
exportToJsonl "\`$DATABRICKS_CATALOG\`.\`some-schema\`.many_columns"
exportToJsonl "\`$DATABRICKS_CATALOG\`.\`some-schema\`.optional_non_nullable"
