...
func (d *Driver[EC, RC]) Spec(ctx context.Context, req *pm.Request_Spec) (*pm.Response_Spec, error) {
	...
	} else if endpoint, err = schemagen.GenerateSchema("SQL Connection", ec).MarshalJSON(); err != nil {
		return nil, fmt.Errorf("generating endpoint schema: %w", err)
	} else if resource, err = schemagen.GenerateSchema("SQL Table", rc).MarshalJSON(); err != nil {
