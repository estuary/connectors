...
class BackfillConfig:
    ...
    work_queue_size: int = 500
    subdivision_queue_size: int = 100
    document_queue_size: int = 5000
...
class QueueManager:
    def __init__(self, work_queue_size: int, subdivision_queue_size: int, document_queue_size: int):
        self.work_queue = Queue(maxsize=work_queue_size)
        self.subdivision_request_queue = Queue(maxsize=subdivision_queue_size)
        self.document_queue = Queue(maxsize=document_queue_size)
...
class WorkManager:
    def __init__(
        ...
        self.queue_manager = QueueManager(
            ...
            document_queue_size=DEFAULT_BACKFILL_CONFIG.document_queue_size
        )
