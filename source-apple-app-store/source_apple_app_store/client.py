...
class AppleAppStoreClient:
    ...
    async def list_analytics_report_requests(
        ...
        return await self._paginated_request(url, AnalyticsReportRequest, params)
    ...
    async def get_analytics_report_details(self, report_id: str) -> AnalyticsReport:
    ...
    async def list_analytic_report_instances(
        ...
        return await self._paginated_request(url, AnalyticsReportInstance, params)
    ...
    async def list_analytics_report_segments(
        ...
        return await self._paginated_request(url, AnalyticsReportSegment, params)
